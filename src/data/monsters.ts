...
export const MONSTERS: MonsterDef[] = [
  // Act 1
  m({ id: 'drowned', name: 'Drowned Sailor', model: 'zombie', color: '#6b7d6a', life: 1.4, damage: 1.1, speed: 2.2, attackSpeed: 0.9 }),
  m({ id: 'crab', name: 'Shore Crab', model: 'crab', color: '#b05a3a', life: 0.9, damage: 0.8, speed: 3.4, armour: 3, radius: 0.5 }),
  m({ id: 'drowned_archer', name: 'Drowned Archer', model: 'skeleton', color: '#8a9a8a', life: 0.8, damage: 0.9, speed: 2.8, skills: [arrow()], kite: 6 }),
  m({
    id: 'tidecaller', name: 'Drowned Tidecaller', model: 'caster', color: '#3a7a8a', ...BOSS, life: 20, damage: 1.6, speed: 2.6,
    types: { cold: 1 }, kite: 5,
    skills: [
  ...
  m({ id: 'bog_spider', name: 'Bog Crawler', model: 'spider', color: '#4a5a2a', life: 0.7, damage: 0.8, speed: 4.6, attackSpeed: 1.4, types: { phys: 0.7, chaos: 0.3 } }),
  m({
    id: 'rhoa', name: 'Mire Rhoa', model: 'beast', color: '#7a6a50', life: 1.3, damage: 1.1, speed: 3.6,
    skills: [melee(1.4), { id: 'charge', kind: 'charge', range: 8, cooldown: 5, weight: 6, dmg: 1.5, params: { distance: 8 } }],
  }),
  m({
    id: 'bog_mother', name: 'The Bog Mother', model: 'spider', color: '#3a4a1a', ...BOSS, scale: 2.6, life: 24, damage: 1.7, speed: 3.2,
  ...
  m({ id: 'wolf', name: 'Ashen Wolf', model: 'beast', color: '#6a6a6a', life: 0.8, damage: 0.9, speed: 5, attackSpeed: 1.5, scale: 0.85 }),
  m({ id: 'bandit_archer', name: 'Outlaw Archer', model: 'humanoid', color: '#7a5a3a', life: 0.9, damage: 1, speed: 3, skills: [arrow()], kite: 7 }),
  m({
    id: 'ash_cultist', name: 'Ash Cultist', model: 'caster', color: '#8a3a2a', life: 0.9, damage: 1.1, speed: 2.8, kite: 7, types: { fire: 1 },
    skills: [bolt('#ff8a3a', { fire: 1 }, { id: 'firebolt', params: { count: 1, spread: 0, speed: 12, size: 0.35, explode: 1.2 } })],
  }),
  m({
    id: 'grove_warden', name: 'The Grove Warden', model: 'brute', color: '#5a4a2a', ...BOSS, scale: 2.2, life: 26, damage: 1.8, speed: 2.4,
    skills: [
      melee(2.4, 1.2),
  ...
  // Act 2
  m({ id: 'skeleton', name: 'Risen Skeleton', model: 'skeleton', color: '#d8d0b8', life: 0.9, damage: 1, speed: 3.1, attackSpeed: 1.1 }),
  m({ id: 'skeleton_archer', name: 'Skeleton Archer', model: 'skeleton', color: '#c8c0a8', life: 0.75, damage: 0.95, speed: 2.9, skills: [arrow()], kite: 7 }),
  m({
    id: 'wraith', name: 'Crypt Wraith', model: 'wraith', color: '#8090c0', life: 0.8, damage: 1.1, speed: 3.4, kite: 6, flying: true,
    types: { cold: 0.5, chaos: 0.5 }, res: { cold: 40, chaos: 30 },
    skills: [bolt('#a8b8ff', { cold: 1 }, { id: 'frostbolt' })],
  }),
  m({
    id: 'crypt_lord', name: 'Lord of the Crypt', model: 'skeleton', color: '#b8b098', ...BOSS, scale: 2.4, life: 30, damage: 2, speed: 3,
    skills: [
  ...
  m({ id: 'cave_bat', name: 'Cave Screecher', model: 'bat', color: '#5a4a5a', life: 0.5, damage: 0.7, speed: 6, attackSpeed: 1.6, flying: true, scale: 0.9, radius: 0.35 }),
  m({
    id: 'venom_spitter', name: 'Venom Spitter', model: 'spider', color: '#6a8a2a', life: 0.85, damage: 1, speed: 3.2, kite: 7, types: { chaos: 1 },
    skills: [bolt('#9adf3a', { chaos: 1 }, { id: 'venom', spell: false })],
  }),
  m({
    id: 'broodmother', name: 'The Broodmother', model: 'spider', color: '#2a2a2a', ...BOSS, scale: 3, life: 32, damage: 2, speed: 3.6,
  ...
  m({
    id: 'brute', name: 'Hulking Brute', model: 'brute', color: '#8a6a5a', life: 2.5, damage: 1.6, speed: 2.3, attackSpeed: 0.8, scale: 1.3, radius: 0.65, armour: 2, xp: 2,
  ...
  m({
    id: 'fallen_knight', name: 'Sir Aldric, the Fallen', model: 'humanoid', color: '#7a7a8a', ...BOSS, scale: 2, life: 34, damage: 2.2, speed: 3.8, armour: 4,
    skills: [
      melee(2.2, 1.3),
  ...
  // Act 3
  m({
    id: 'frost_witch', name: 'Rime Witch', model: 'caster', color: '#6a8aba', life: 0.95, damage: 1.1, speed: 2.9, kite: 7, types: { cold: 1 }, res: { cold: 50 },
    skills: [
  ...
  m({
    id: 'deep_horror', name: 'The Deep Horror', model: 'beast', color: '#2a3a4a', ...BOSS, scale: 2.6, life: 36, damage: 2.2, speed: 4,
  ...
  m({
    id: 'imp', name: 'Cinder Imp', model: 'imp', color: '#c05a2a', life: 0.6, damage: 0.9, speed: 5.4, attackSpeed: 1.5, scale: 0.8, radius: 0.35, types: { phys: 0.4, fire: 0.6 }, res: { fire: 60 },
    skills: [melee(1.1), bolt('#ff8a3a', { fire: 1 }, { id: 'spark', cooldown: 3, weight: 4 })],
  }),
  m({
    id: 'ember_priest', name: 'High Priest of Embers', model: 'caster', color: '#c04a1a', ...BOSS, scale: 2.2, life: 34, damage: 2.3, speed: 3, kite: 5,
  ...
  // Act 4
  m({
    id: 'yeti', name: 'Mountain Yeti', model: 'brute', color: '#d0d8e0', life: 2.3, damage: 1.5, speed: 2.7, scale: 1.3, radius: 0.65, types: { phys: 0.6, cold: 0.4 }, res: { cold: 50 }, xp: 2,
  ...
  m({
    id: 'rime_giant', name: 'The Rime Giant', model: 'brute', color: '#a0c0e0', ...BOSS, scale: 3, radius: 1.3, life: 40, damage: 2.4, speed: 2.8,
  ...
  m({
    id: 'forsaken_king', name: 'The Forsaken King', model: 'humanoid', color: '#6a3a8a', ...BOSS, scale: 2.5, radius: 1.1, life: 55, damage: 2.6, speed: 3.6,
  ...
  // Player minion
  m({ id: 'bone_warrior', name: 'Bone Warrior', model: 'skeleton', color: '#e8e0c8', life: 1, damage: 1, speed: 5.2, attackSpeed: 1.3 }),
];
...
export const RARE_MODS: RareMonsterMod[] = [
  { id: 'hasted', name: 'Hasted', speedInc: 35, attackSpeedInc: 20 },
  { id: 'armoured', name: 'Armoured', physReduction: 35 },
  { id: 'regenerating', name: 'Regenerating', regenPct: 3 },
  { id: 'vampiric', name: 'Vampiric', leech: 0.1 },
  { id: 'flame', name: 'Flame-touched', extra: { fire: 60 }, res: { fire: 40 } },
  { id: 'frost', name: 'Frost-touched', extra: { cold: 60 }, res: { cold: 40 } },
  { id: 'storm', name: 'Storm-touched', extra: { lightning: 60 }, res: { lightning: 40 } },
  { id: 'empowered', name: 'Empowered', damageMore: 35 },
  { id: 'resilient', name: 'Resilient', lifeMore: 50 },
  { id: 'venomous', name: 'Venomous', poison: 50 },
  { id: 'frenzied', name: 'Frenzied', attackSpeedInc: 40 },
  { id: 'warded', name: 'Elementally Warded', res: { fire: 40, cold: 40, lightning: 40 } },
];
